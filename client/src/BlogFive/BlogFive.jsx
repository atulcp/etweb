...
const BlogFive = () => {
  return (
    <>
      <div id='Blog Page Big Div' className="text-gray-900 bg-black">
        <section id='Blog Page Section' className="flex flex-col justify-center max-w-6xl min-h-screen px-4 py-10 mx-auto sm:px-6">
          <div id='Blog Header Div' className="flex flex-wrap items-center justify-between mb-8">
            <h2 id='Blog Header' className="mr-10 font-oswald text-4xl font-bold text-orange-500 leading-none md:text-5xl">
              Blogs
            </h2>
            <a id='See All Blogs' href="/allblogs" className="block pb-1 mt-2 text-base font-black font-oswald text-orange-600 uppercase border-b border-transparent hover:border-orange-600">
              See All Blogs 
            </a>
          </div>
              ...
              <div id='Blog Card1 Div' className="flex flex-grow">
                <div id='Blog Card1 Flex Div' className="flex flex-col justify-between px-4 py-6 bg-white border border-gray-400 rounded-md">
                  <div id='Blog Card1 Descrip. Div'>
                    <a href="/founder" className="inline-block mb-4 text-sm font-oswald font-bold capitalize border-b-2 border-orange-600 hover:text-orange-600">Atul Pandey</a>
              ...
              <div id='Blog Card2 Div' className="flex flex-grow">
                <div id='Blog Card2 Flex Div' className="flex flex-col justify-between px-4 py-6 bg-white border border-gray-400 rounded-md">
                  <div id='Blog Card2 Descrip. Div'>
                    <a href="/founder" className="inline-block mb-4 text-xs font-oswald font-bold capitalize border-b-2 border-orange-600 hover:text-orange-600">Atul Pandey</a>
